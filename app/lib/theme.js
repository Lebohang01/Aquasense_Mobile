...
// Community post categories — alert/resolved/tip deliberately reuse
// STATUS colors since they're semantically the same idea (bad/good/caution)
export const CATEGORIES = {
  general:       { color: C.blue,               bg: 'rgba(15,160,223,0.12)', emoji: '💬' },
  water_quality: { color: C.cyan,               bg: 'rgba(15,143,191,0.12)', emoji: '💧' },
  alert:         { color: STATUS.UNSAFE.color,  bg: STATUS.UNSAFE.bg,        emoji: '🚨' },
  resolved:      { color: STATUS.SAFE.color,    bg: STATUS.SAFE.bg,          emoji: '✅' },
  tip:           { color: STATUS.CAUTION.color, bg: STATUS.CAUTION.bg,       emoji: '💡' },
  question:      { color: C.purple,             bg: 'rgba(124,58,237,0.12)', emoji: '❓' },
};
