...
const s=StyleSheet.create({
  ...
  catCardOn:{backgroundColor:'rgba(15,160,223,0.12)',borderColor:C.blue},
  catLbl:{fontSize:12,fontWeight:'700',color:C.text1,textAlign:'center'},catLblOn:{color:C.blue},
  ...
  optOn:{backgroundColor:'rgba(15,160,223,0.15)',borderColor:C.blue},
  optTxt:{fontSize:12,fontWeight:'500',color:C.text1},optTxtOn:{color:C.blue},
  preview:{backgroundColor:C.bg2,borderRadius:12,padding:14,borderWidth:1,borderColor:'rgba(15,160,223,0.3)'},
  previewLbl:{fontSize:10,fontWeight:'700',color:C.blue,letterSpacing:0.8,marginBottom:8},
